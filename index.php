...
if(isset($_POST['submit'])) {
   $user = $_POST['username'];
   $pwd = $_POST['password'];
   $query = "SELECT * FROM `users` WHERE email='$user' && `password`='$pwd'";
   ...
   if($total==1){
     ...
     echo "<script>location='login/dashboard'</script>";
   }
   else
   {
...
<head>
  ...
  <title>Pet diagnostics</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="login/assets/img/favicon.png" rel="icon">
...
<body>
  ...
  <script src="login/assets/vendor/quill/quill.min.js"></script>
